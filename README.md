...
1. [Optional]: User Authenticating with Google Accounts in Web Clients
    ...
    1. Update the `WEB_CLIENT_ID` in [Constants.java](src/main/java/com/github/mhdirkse/westit/lcm/Constants.java)
...
1. [Optional]: User Authenticating with Google Accounts in other Applications
   Types
    ...
    - Inside [Constants.java](src/main/java/com/github/mhdirkse/westit/lcm/Constants.java)
...
https://cloud.google.com/endpoints/docs/frameworks/java/test-deploy#generating_and_deploying_an_api_configuration

Visit API explorer.
Go to method.
Press Authorize and execute.
Fill in the scope.
Press Authorize and execute.
